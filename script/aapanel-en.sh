#! /bin/bash
# By Aaron
# https://github.com/AGWA5783/aaPanel
...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://subweb.s3.fr-par.scw.cloud/aaPanel/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://ghproxy.com/https://raw.githubusercontent.com/AGWA5783/aapanel/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://subweb.s3.fr-par.scw.cloud/aaPanel/LinuxPanel-7.7.0.zip"
...
wget https://ghproxy.com/https://raw.githubusercontent.com/AGWA5783/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
...
wget -O /root/chinese.zip https://subweb.s3.fr-par.scw.cloud/aaPanel/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/AGWA5783/aaPanel"
    yellow " ————————————————————————————————————————————————"
